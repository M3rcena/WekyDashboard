...
export const docsConfig: DocCategory[] = [
	...
	},
	{
		...
		items: [
			...
			{ title: "Guess The Number", slug: "game-guess-number" },
			{ title: "Guess The Pokemon", slug: "game-guess-pokemon" },
			{ title: "Hangman", slug: "game-hangman" },
			{ title: "Lie Swatter", slug: "game-lie-swatter" },
			{ title: "Never Have I Ever", slug: "game-nhie" },
			{ title: "Quick Click", slug: "game-quick-click" },
	...
	},
	{
		...
		items: [
			...
			{ title: "Quick Click", slug: "types-quick-click" },
