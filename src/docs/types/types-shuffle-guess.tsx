					...
					<table className="w-full text-left text-sm text-gray-400">
						...
						<tbody className="divide-y divide-white/5">
							<tr>
								...
								<td className="p-4">
									<code className="bg-white/10 px-1 rounded">{"{{word}}"}</code> (Scrambled){" "}
							...
							<tr>
								...
								<td className="p-4">
									<code className="bg-white/10 px-1 rounded">{"{{word}}"}</code> (Correct Word){" "}
									<code className="bg-white/10 px-1 rounded">{"{{time}}"}</code>
								</td>
							</tr>
							<tr>
								...
								<td className="p-4">
									<code className="bg-white/10 px-1 rounded">{"{{answer}}"}</code> (Correct Word)
								</td>
							</tr>
							<tr>
