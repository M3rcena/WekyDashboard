    ...
    <div className="group flex flex-col md:flex-row md:items-start gap-4 p-5 border-b border-white/5 last:border-0 hover:bg-white/2 transition-all duration-300">
        <div className="md:w-52 shrink-0">
            <div className="flex items-center gap-2 mb-1.5">
                ...
                {required && <span className="text-[10px] text-red-400 font-bold px-1.5 py-0.5 bg-red-500/10 rounded">REQ</span>}
            </div>
...
const StatusCard = ({ icon: Icon, color, title, items }: { icon: LucideIcon, color: string, title: string, items: { key: string, desc: string }[] }) => {
    ...
    return (
        <div className="relative overflow-hidden rounded-xl border border-white/10 bg-[#121214] hover:border-white/20 transition-colors group h-full">
            ...
            <div className="p-5 relative z-10">
                <div className={`inline-flex items-center gap-2 mb-4 px-2 py-1 rounded-md border text-xs font-bold uppercase tracking-wider ${activeColor}`}>
...
export default function TypesGuessThePokemon() {
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 max-w-5xl mx-auto p-4 sm:p-6">
            ...
            <header className="mb-16">
                ...
                <h1 className="text-4xl sm:text-5xl font-extrabold text-white tracking-tight mb-6">
                    Types<span className="text-transparent bg-clip-text bg-linear-to-r from-purple-400 to-pink-400">GuessThePokemon</span>
                </h1>
                <p className="text-lg text-gray-400 leading-relaxed max-w-2xl">
                    Configuration options for the Pokémon trivia minigame.
                </p>
            </header>
            ...
            <section className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
                ...
                {/* Info Card */}
                 <div className="rounded-xl border border-white/10 bg-[#0d0d0e] p-6 flex flex-col items-center justify-center text-center">
                    <Ghost className="w-12 h-12 text-purple-500/20 mb-4" />
                    <h3 className="font-bold text-white mb-2">No API Key?</h3>
                    <p className="text-xs text-gray-500">
                        This minigame uses the public PokéAPI. It does not require any additional setup or API keys to function!
                    </p>
                </div>
            </section>
            ...
            <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                    ...
                    <StatusCard 
                        ...
                        title="Success"
                        items={[
                            { key: "winMessage", desc: "Sent when player guesses correctly." }
                        ]}
                    />
                    ...
                    <StatusCard 
                        ...
                        title="Failure"
                        items={[
                            { key: "loseMessage", desc: "Sent on timeout or give up." },
                            { key: "incorrectMessage", desc: "Sent when guess is wrong." }
                        ]}
                    />
                     ...
                     <StatusCard 
                        ...
                        items={[
                            ...
                            { key: "states.active", desc: "Main game embed body." }
                        ]}
                    />
                     ...
                     <StatusCard 
                        ...
                        title="Errors"
                        items={[
                            { key: "states.error", desc: "API failure fallback." }
                        ]}
                    />
                </div>
            </section>
