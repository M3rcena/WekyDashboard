				...
				<div className="overflow-hidden rounded-xl border border-white/10 bg-[#0d0d0e]">
					<table className="w-full text-left text-sm text-gray-400">
						...
						<tbody className="divide-y divide-white/5">
							...
							<tr>
								<td className="p-4 font-mono text-purple-300">loseMessage / incorrectMessage</td>
								<td className="p-4">
									<code className="bg-white/10 px-1 rounded">{"{{answer}}"}</code> (Correct Pokemon Name)
								</td>
							</tr>
							<tr>
								...
								<td className="p-4">
									...
									<code className="bg-white/10 px-1 rounded">{"{{types}}"}</code>{" "}
									<code className="bg-white/10 px-1 rounded">{"{{abilities}}"}</code>{" "}
									<code className="bg-white/10 px-1 rounded">{"{{time}}"}</code>
								</td>
							</tr>
							<tr>
								<td className="p-4 font-mono text-purple-300">states.wrong</td>
								<td className="p-4">
									<code className="bg-white/10 px-1 rounded">{"{{wrongMsg}}"}</code> + types/abilities
								</td>
							</tr>
						</tbody>
					</table>
